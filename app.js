...
// [ID, 類別, 題目, 選項A文字, 選項B文字, 正確選項, 圖片A序號, 圖片B序號]
const questions = [
  ["h1", "衛生", "吃完飯後，我會...?", "玩玩具", "刷牙", "b", 2, 1],
  ["h2", "衛生", "睡覺前，我會...?", "洗澡", "髒髒的去睡覺", "a", 3, 4],
  ["h3", "衛生", "上廁所後，我會…?", "跑去玩", "洗手", "b", 6, 5],
  ["h4", "衛生", "打噴嚏的時候，我會…?", "遮口鼻", "直接打噴嚏", "a", 7, 8],
  ["h5", "衛生", "吃飯的時候，我會用….?", "髒髒餐具組", "乾淨餐具組", "b", 10, 9],
 ...
 ["e3", "運動", "我想讓身體更健康，我會⋯？", "游泳", "玩電腦", "a", 17, 18],
  ...
  ["s15", "安全", "如果我不小心受傷流血了，我會…", "自己躲起來哭", "找大人幫忙", "b", 84, 83]
];
